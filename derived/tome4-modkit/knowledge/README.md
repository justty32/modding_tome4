...
**這裡比 `~/repo/moddings/tome4/analysis/t-engine/` 可信。** 那份只是索引。
...
| 代號 | 實際路徑 | 性質 |
|---|---|---|
| `E` | `~/repo/moddings/tome4/projects/t-engine4/engines/te4-1.7.6/engine` | 引擎原始碼，唯讀 |
| `M` | `~/repo/moddings/tome4/projects/t-engine4/modules/tome` | ToME 模組原始碼，唯讀 |
| `R` | `~/repo/moddings/tome4/external/orig` | 實裝過的第三方 addon，唯讀 |
