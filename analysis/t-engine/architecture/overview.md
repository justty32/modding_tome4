...
> **本地原始碼位置（2026-07-05 起）**：Lua 層原始碼解壓自 Steam 版封包，位於 `projects/t-engine4/`：
> - 引擎 Lua 層 `engine/*.lua` → `projects/t-engine4/engines/te4-1.7.6/engine/`
> - ToME 內容層 `mod/`、`data/` → `projects/t-engine4/modules/tome/`
