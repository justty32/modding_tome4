...
Lua 層原始碼（解壓自 Steam 版封包，2026-07-05）位於工作區 `vendor/t-engine4/`：

| 教學中引用的路徑 | 本地實際位置 |
|------|------|
| `game/engines/te4-1.7.6/engine/` | `vendor/t-engine4/engines/te4-1.7.6/engine/` |
| `game/modules/tome/`（`mod/` + `data/`） | `vendor/t-engine4/modules/tome/` |
